...
if __name__ == "__main__":
    model = loadOnnxModel("models/vgg16-ssd.onnx")
    node_nums = getNodeNum(model)
    print(node_nums)
    op_name = getNodetype(model)
    print(op_name)
    nodenames = getNodeNameList(model)
    print(nodenames)
    node103 = model.graph.node[103]
    print(node103)
